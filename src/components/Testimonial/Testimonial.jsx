...
const TestimonialData = [
    {
     id:1,
     name: "Victor",
     text: "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Maiores, dolorem commodi necessitatibus quibusdam, assumenda aspernatur molestias .",
...
const Testimonial = () => {
  ...
  return (
    <div className="py-10 mb-10">
     ...
     <h1 data-aos="fade-up" className="text-3xlfont-bold">Testimonials</h1>
