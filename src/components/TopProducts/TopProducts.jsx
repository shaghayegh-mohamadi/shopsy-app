         ...
         ProductsData.map((data) => (
           ...
           ">
            ...
            <div className="h-[100px]">
             <img src={data.img}
             className="max-w-[140px] block mx-auto transform -translate-y-20 group-hover:slace-105 duration-300 drop-shadow-md"
             />
            </div>
            {/* details section */}
            <div className="p-4 text-center">
              ...
              <button className="bg-primary hover:scale-105 duration-300 text-white rounded-full mt-4  group-hover:bg-white group-hover:text-primary "
